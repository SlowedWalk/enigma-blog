    ...
    <>
      <input
        ...
        className={twMerge([
          ...
          "transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md placeholder:text-slate-400/90 dark:placeholder:text-slate-500/80",
